...
public class FeatureControllerTest {
    ...
    void setUp() {
        ...
        feature1 = new Feature(1L, 1L, "Feature Title 1", "Feature Description 1", "String", "Type 1", true, false, "Units 1", "Equipment 1", "Data Collection 1", LocalDateTime.now(), 1L, LocalDateTime.now(), 1L);
        feature2 = new Feature(2L, 1L, "Feature Title 2", "Feature Description 2", "String", "Type 2", false, true, "Units 2", "Equipment 2", "Data Collection 2", LocalDateTime.now(), 1L, LocalDateTime.now(), 1L);
    }

    /**
     * Tests the {@link FeatureController#getAllFeatures()} method.
    ...
    void testGetAllFeatures() {
        ...
        ResponseEntity<List<Feature>> response = featureController.getAllFeatures();
    ...
    /**
     * Tests the {@link FeatureController#getFeaturesByFeatureSetId(Long)} method.
     * Verifies that feature list is returned with a status of 200 OK.
     */
    @Test
    void testGetFeaturesByFeatureSetId() {
        when(featureService.findByFeaturesetId(1L)).thenReturn(Arrays.asList(feature1, feature2));

        ResponseEntity<List<Feature>> response = featureController.getFeaturesByFeatureSetId(1L);
